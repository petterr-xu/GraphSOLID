    ...
    for trial_idx in range(trial_runs):
        ...
        if victim_engine == "dense_surrogate":
            ...
            classifier_eg = classifier_engine.RoHeClassifierEngine(
                ...
                hidden_size=int(getattr(cfg.general, "rohe_hidden_units", 32)),
                num_heads=[int(getattr(cfg.general, "rohe_num_heads", 8))],
                dropout=float(getattr(cfg.general, "rohe_dropout", 0.2)),
        ...
        evasion_kwargs = dict(
            ...
            early_stop_patience=int(getattr(cfg.general, "victim_patience", 10)),
