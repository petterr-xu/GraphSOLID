...
class GAT(nn.Module):
    def __init__(self, in_feat, nhid, out_feat, nlayer=3, dropout=0.5):
        ...
        self.conv1 = GATConv(in_feat, head_dim, heads=num_head)
        self.conv2 = GATConv(nhid, out_feat)
...
class GAT_single(nn.Module):
    def __init__(self, nfeat, nhid, nclass, nlayer=1, dropout=0.5):
        super(GAT_single, self).__init__()
