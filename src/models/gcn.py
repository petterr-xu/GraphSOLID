...
class GCN(nn.Module):
    def __init__(self, in_feat, nhid, out_feat,nlayer=3, dropout=0.5):
        super(GCN, self).__init__()
        self.conv1 = GCNConv(in_feat, nhid, cached= False, normalize=True)
        self.conv2 = GCNConv(nhid, out_feat, cached=False, normalize=True)
...
class GCN_single(nn.Module):
    def __init__(self, nfeat, nhid, out_feat, nlayer=1, dropout=0.5):
        super(GCN_single, self).__init__()
        self.conv1 = GCNConv(nfeat, out_feat, cached=False, normalize=True)
        self.reg_params = []
        self.dropout_p = dropout
