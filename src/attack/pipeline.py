    ...
    def defend_after_attack(
        ...
        summary: Dict[str, Any] = {
            ...
            "metrics": {
                ...
                "attacked_target_asr_on_attacked": attacked_target_summary["asr_on_attacked"],
                "attacked_target_nfr": attacked_target_summary["nfr"],
                "defended_target_nodes_evaluated": defended_target_summary["target_eval_count"],
                "defended_target_graphs": defended_target_summary["samples_with_targets"],
                ...
                "defense_recovery_target_nodes_evaluated": recovery_summary["target_eval_count"],
                "defense_recovery_target_graphs": recovery_summary["samples_with_targets"],
